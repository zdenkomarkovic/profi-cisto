...
const images = [
  {
    src: "/images/ciscenje (1).jpg",
    alt: "Pranje staklene fasade",
    caption: "Pranje staklene fasade",
  },
  {
    src: "/images/ciscenje (2).jpg",
    alt: "Pranje stakla iznutra",
    caption: "Pranje stakla iznutra",
  },
  {
    src: "/images/ciscenje (3).jpg",
    alt: "Mašinsko pranje podova",
    caption: "Mašinsko pranje podova",
  },
  {
    src: "/images/ciscenje (4).jpg",
    alt: "Industrijsko čišćenje",
    caption: "Industrijsko čišćenje",
  },
  {
    src: "/images/ciscenje (6).jpg",
    alt: "Pranje staklenih zidova",
    caption: "Pranje staklenih zidova",
  },

  {
    src: "/images/ciscenje (8).jpg",
    alt: "Pranje spoljnih površina",
    caption: "Pranje spoljnih površina",
  },
  {
    src: "/images/ciscenje (9).jpg",
    alt: "Visoko pranje stakla",
    caption: "Visoko pranje stakla",
  },
  {
    src: "/images/ciscenje (10).jpg",
    alt: "Pranje staklenih vrata",
    caption: "Pranje staklenih vrata",
  },
];
