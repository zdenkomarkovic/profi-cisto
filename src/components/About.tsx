        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg mb-6 leading-relaxed">
              <strong>Profi Čisto</strong> je beogradska agencija za
              profesionalno čišćenje i održavanje poslovnih i stambenih
              objekata. Sa više od 5 godina iskustva, opslužujemo kompanije,
              stambene zajednice i privatne klijente širom Beograda.
            </p>
            <p className="text-gray-600 mb-8 leading-relaxed">
              Naš tim je obučen za rad sa savremenom industrijskom opremom.
              Koristimo ekološki prihvatljiva sredstva koja su bezbedna za vaše
              zaposlene i stanare. Svaki projekat završavamo temeljno i na
              vreme.
            </p>
